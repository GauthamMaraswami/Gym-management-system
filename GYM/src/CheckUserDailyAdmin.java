...
public class CheckUserDailyAdmin implements ActionListener {
	JFrame frame;
	JFrame frame1;
	JPanel panel,panel1;
	JButton add,generate,b3,b4,b5,b6;
	Font font1,font2,font3;
	JLabel headingLabel, uid1,calories,name1,uid2,name2,Inst1,Inst2,heading1,id1,date1,time1,calories1,id2,date2,time2,calories2;
	JTextField time;

	public CheckUserDailyAdmin()
	{
		font1=new Font("Georgia",Font.BOLD,20);
		font2 = new Font("Georgia",Font.BOLD,15);
		font3 = new Font("Georgia",Font.BOLD,35);
		frame1 = new JFrame("All Students Daily Reports");
		panel1 = new JPanel();
		heading1 = new JLabel("All Students Daily Reports ");
		...
		Inst1.setBounds(1000, 200, 200, 30);
		Inst1.setFont(font1);
		date1=new JLabel("Date");
		date1.setBounds(1200, 200, 200, 30);
		time1=new JLabel("time");
		time1.setBounds(1400, 200, 200, 30);
		calories1=new JLabel("calories");
		calories1.setBounds(1600, 200, 200, 30);
		date1.setFont(font1);
		time1.setFont(font1);
		...
		try {
            ...
            String query="select D.id,U.name,D.uid,D.date_of_report,D.calories_burnt,D.time_spent,I.name from Daily_report as D,User as U,Instructor as I where  D.uid=U.User_id and U.Inst_id=I.Inst_id order by(D.date_of_report) desc,D.calories_burnt desc";
        	...
        	while(rs.next()) {
    			...
    			Inst2.setBounds(1000, 200+ptr, 200, 30);
    			Inst2.setFont(font1);
    			date2=new JLabel(rs.getString(4));
    			date2.setBounds(1200, 200+ptr, 200, 30);
    			time2=new JLabel(rs.getString(6));
    			time2.setBounds(1400, 200+ptr, 200, 30);
    			calories2=new JLabel(rs.getString(5));
    			calories2.setBounds(1600, 200+ptr, 200, 30);
    			date2.setFont(font2);
    			time2.setFont(font2);
